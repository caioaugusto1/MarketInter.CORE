    ...
    public class MappingsProfile : Profile
    {
        public MappingsProfile()
        {
            CreateMap<EnvironmentViewModel, SystemEnvironment>()
                ...
                .ForMember(x => x.FinishDate, y => y.MapFrom(f => DateTime.Parse(f.FinishDate.ToString(), new CultureInfo("pt-BR"))))
            ...
            CreateMap<CollegeTime, CollegeTimeViewModel>()
                ...
                .ForMember(x => x.RenewPrice, y => y.MapFrom(f => Math.Round(f.RenewPrice, 2)))
            ...
            CreateMap<CulturalExchange, CulturalExchangeViewModel>()
               ...
               .ForMember(x => x.AccomodationId, y => y.MapFrom(f => f.AccomodationId == Guid.Empty ? null : Convert.ToString(f.AccomodationId)))
               .ForMember(x => x.CollegeTimeViewModel, y => y.MapFrom(f => f.CollegeTime))
               .ForMember(x => x.EnvironmentViewModel, y => y.MapFrom(f => f.Environment))
               ...
               .ForMember(x => x.ArrivalDateTime, y => y.MapFrom(f => f.ArrivalDateTime.HasValue ? DateTime.Parse(f.ArrivalDateTime.Value.ToString("dd/MM/yyyy HH:mm"), new CultureInfo("pt-BR")) : DateTime.MinValue))
               .ForMember(x => x.StartDate, y => y.MapFrom(f => DateTime.Parse(f.StartDate.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR"))))
               .ForMember(x => x.SaleDate, y => y.MapFrom(f => DateTime.Parse(f.SaleDate.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR"))))
               .ForMember(x => x.StartAccomodation, y => y.MapFrom(f => f.StartAccomodation.HasValue ? DateTime.Parse(f.StartAccomodation.Value.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR")) : DateTime.MinValue))
               .ForMember(x => x.FinishAccomodation, y => y.MapFrom(f => f.FinishAccomodation.HasValue ? DateTime.Parse(f.FinishAccomodation.Value.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR")) : DateTime.MinValue))
               ...
               .ForMember(x => x.TotalValue, y => y.MapFrom(f => Math.Round(f.TotalValue, 2)))
               .ReverseMap();
            ...
            CreateMap<ReceivePaymentCulturalExchange, ReceivePaymentCulturalExchangeViewModel>()
               ...
               .ForMember(x => x.DateOfPayment, y => y.MapFrom(f => DateTime.Parse(f.DateOfPayment.ToString(), new CultureInfo("pt-BR"))))

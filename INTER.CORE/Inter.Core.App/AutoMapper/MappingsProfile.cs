    ...
    public class MappingsProfile : Profile
    {
        public MappingsProfile()
        {
            ...
            CreateMap<CulturalExchange, CulturalExchangeViewModel>()
               ...
               .ForMember(x => x.ArrivalDateTime, y => y.MapFrom(f => f.ArrivalDateTime != null ? DateTime.Parse(f.ArrivalDateTime.ToString(), new CultureInfo("pt-BR")) : DateTime.MinValue))
               .ForMember(x => x.StartDate, y => y.MapFrom(f => DateTime.Parse(f.StartDate.ToString(), new CultureInfo("pt-BR"))))
               .ForMember(x => x.StartAccomodation, y => y.MapFrom(f => DateTime.Parse(f.StartAccomodation.ToString(), new CultureInfo("pt-BR"))))
               .ForMember(x => x.FinishAccomodation, y => y.MapFrom(f => DateTime.Parse(f.FinishAccomodation.ToString(), new CultureInfo("pt-BR"))))
               ...
               .ForMember(x => x.SaleDate, y => y.MapFrom(f => f.SaleDate))

    ...
    public class MappingsProfile : Profile
    {
        public MappingsProfile()
        {
            ...
            CreateMap<CulturalExchange, CulturalExchangeViewModel>()
               ...
               .ForMember(x => x.StartAccomodation, y => y.MapFrom(f => DateTime.Parse(f.StartAccomodation.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR"))))
               .ForMember(x => x.FinishAccomodation, y => y.MapFrom(f => DateTime.Parse(f.FinishAccomodation.ToString("dd/MM/yyyy"), new CultureInfo("pt-BR"))))
